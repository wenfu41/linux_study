...
### 2025-11-29: 修复软件包界面空白问题
- **问题描述**: 软件包界面显示空白,无法加载软件包列表
- **根本原因**: `lib/data/packages.json` 文件第68行存在JSON格式错误,字符串中包含未转义的双引号
- **具体错误**: `"Nmap ("Network Mapper")` 中的双引号未转义
- **解决方案**: 将双引号转义为 `\"`,修改为 `"Nmap (\"Network Mapper\")"`
- **影响范围**: 仅影响软件包功能,其他功能正常
